...
"Grocery Shopping + 5",
    ...
    A_plus_skills = ("Master Planner", 
"Financial IQ + 40",
"Saving + 4",
"Budgeting + 4")
    
    A_skills = (Financially Literate 
Problem Solver 
Great Credit Score
Schedule Planning + 4
Financial IQ + 30
...
Sword Prowess Lvl. 2 
    ...
    D_plus_skills = (Grocery Shopping + 2
Average Spender 
)
    D_skills = (Budgeting + 1
Saving + 1
Sword Prowess Lvl. 1 
)
